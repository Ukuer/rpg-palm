...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataset_mode', type=str, default='unaligned', help='unaligned, aligned,single')
        parser.add_argument('--model', type=str, default='rpg', help='chooses which model to use. bicycle,, ...')
